...
import  ss_settings as settings
...
class PairLoaderProcess(Process):
    ...
    def __prepross(self, frame_dict, shape = None):
        ...
        ori_img = image*255
        # cv2.imwrite('/home/hancen/MGN/0.jpg',image)
        ...
        return image, label, shape, ori_img
    ...
    def load_frame(self, player, first_index, second_index):
        ...
        for ind in first_index:
            ...
            image1, label1, shape1, ori_img1 = self.__prepross(frame1_dict, shape1)
            images1.append(image1.transpose((2,0,1)))
            labels1.append(label1)
            ori_imgs1.append(ori_img1)
            image_path.append(frame1_dict['image_path'])
        item = dict(first_img=images1, image1_path=image_path, ori_img1=ori_imgs1)

        if second_index is not None:
            frame2_dict = player.get_frame(second_index)
            image2, label2, shape, ori_img2 = self.__prepross(frame2_dict, self.second_shape)
            item['second_img'] = [image2.transpose((2,0,1))]
            item['ori_img2'] = [ori_img2]
        ...
        if self.deploy_mode:
            ...
            for ind in first_index:
                ...
                first_mask_orig.append(b[0])
                first_mask_scribble.append(b[1])
            ...
            deploy_info = dict(seq_name=player.name, 
                               ...
                               first_mask_scribble=first_mask_scribble,
            ...
            if second_index is not None:
                ...
                deploy_info.update(second_index=second_index,
                                   ...
                                   second_mask_orig=second_mask_orig[0],
                                   second_mask_scribble=second_mask_orig[1],
...
class SSDatalayer():
    def __init__(self, test_group, k_shot=1):
        ...
        self.param_str = {
            ...
            'has_cont':False,
            'deploy_mode':True,
            'pascal_path':'/home/zhiyuan/dataset/VOCdevkit/VOC2012'
        }
