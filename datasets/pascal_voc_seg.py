...
class pascal_voc_seg(imdb):
    ...
    def getItems(self):
        ...
        for i in range(len(self._image_ids)):
            ...
            item['mask_path'], item['scribble_path'] = self.mask_path_at(i)
    ...
    def mask_path_at(self, i):
        ...
        scribble_path = os.path.join(self._data_path, 'ScribbleAugAuto', self._image_ids[i]+'.png')

        return mask_path, scribble_path
